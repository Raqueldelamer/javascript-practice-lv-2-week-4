...
exampleAnimals.push({ species: 'Crow', sound: 'Caw' });

let animalSoundList = '';
for (let i = 0; i < exampleAnimals.length; i++) {
    animalSoundList += exampleAnimals[i].sound;
    animalSoundList += ', ';
}
console.log('Animal Sound List:', animalSoundList);
